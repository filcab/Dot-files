...
if !exists( "g:loaded_youcompleteme" )
  ...
  " This should be independent of language, but let's start with the C family
  " only Later maybe have a function/macro/whatever to setup for the different
  " file types
  augroup cpp
    au Filetype c,objc,cpp,objcpp let maplocalleader=','
    " General (refresh)
